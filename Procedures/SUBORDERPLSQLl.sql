...
CREATE OR REPLACE PROCEDURE INSERT_DATA_TO_SUBORDER(CUSTOMER_ID IN NUMBER,FOOD_ID IN NUMBER, QTY IN NUMBER, ORDER_ID IN NUMBER , SUPPLIER_ID IN NUMBER, STATUS IN VARCHAR2)
IS
BEGIN
    INSERT
    INTO SUBORDER_TABLE (SUBORDER_CUSTOMER_ID , SUBORDER_FOOD_ID , SUBORDER_QTY , SUBORDER_ORDER_ID , SUBORDER_SUPPLIER_ID, SUBORDER_STATUS)
    VALUES (CUSTOMER_ID , FOOD_ID , QTY , ORDER_ID , SUPPLIER_ID , STATUS);
...
BEGIN
    ...
    SELECT SUBORDER_ID , SUBORDER_CUSTOMER_ID , SUBORDER_FOOD_ID , SUBORDER_QTY , SUBORDER_ORDER_ID , SUBORDER_SUPPLIER_ID , SUBORDER_STATUS
    FROM SUBORDER_TABLE
