...
--insert an order
CREATE OR REPLACE PROCEDURE INSERT_ORDER_DATA(TOTAL_PRICE IN NUMBER, CUSTOMER_ID IN NUMBER, STATUS IN VARCHAR2)
IS
BEGIN
    INSERT
    INTO ORDER_TABLE(ORDER_TOTAL_PRICE, ORDER_CUSTOMER_ID, ORDER_STATUS)
